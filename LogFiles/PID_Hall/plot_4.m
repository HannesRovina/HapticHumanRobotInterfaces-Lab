...
filename = 'C:\Users\Hannes\Desktop\Master\HapticHumanRobotInterfaces\LogFiles\PID_Hall\p05i0001d0008.csv';
delimiter = ';';
startRow = 2;
...
time = p05i0001d0008.timestamps(5993:end)-571.9;
theta = p05i0001d0008.paddle_pos_filtdeg(5993:end);
...
legend('PID simulation','Target angle','Maximum Overshoot 1.59°','Upper error 10.2°','Lower error 9.8°','Location','southeast')
xlabel('Time [s]')
ylabel('Angle [deg]')
xlim([-0.5 3])
ylim([-0.5 14])
saveas(plt,'Simulink_PID_hall4.png')


t_init = find(theta>0.07,1);
